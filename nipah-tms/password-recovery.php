...
<head>
    ...
    <title>Nipah virus (NiV) Testing Management System | Admin Login</title>
...
<body class="bg-gradient-primary">
 ...
 <h3 align="center" style="margin-top:4%;color:#fff">Nipah virus (NiV) Testing Management System</h3>
